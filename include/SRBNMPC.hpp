...
private: 
    ...
    //Hardware
    std::string lib_name_exp = "/home/trec/WorkRaj/raisim_legged/FootstepPlanner/build/take2_w0p2.so";//"/home/taizoon/raisimEnvT/rWorkspace/footstep_planner/build/take2_w0p2.so";

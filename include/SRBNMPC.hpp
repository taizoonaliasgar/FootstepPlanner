...
private: 
    ...
    //Hardware
    std::string lib_name_exp = "/home/trec/WorkRaj/raisim_legged/FootstepPlanner/build/take2_w0p2N20.so";//take2_w0p2N12.so";
    ...
    casadi::DM q0_MT = casadi::DM::zeros(16,1);//Eigen::Matrix<double,16,1>::Zero();
    int controlMPC_MT = 0;

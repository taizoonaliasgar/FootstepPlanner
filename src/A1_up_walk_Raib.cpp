...
void controller(std::vector<raisim::ArticulatedSystem *> A1, LocoWrapperwalk *loco_obj, SRBNMPCR* loco_plan, casadi::Function solver, size_t controlTick, raisim::Contact contactInstance) {
    /////////////////////////////////////////////////////////////////////
    //////////////////////////// INITIALIZE
    /////////////////////////////////////////////////////////////////////
    ...
    //casadi::DM X_prev = casadi::DM::zeros(16,1);
    /////////////////////////////////////////////////////////////////////
    //////////////////////////// CONTROL
    /////////////////////////////////////////////////////////////////////
    ...
    if(controlTick < settling){ // Settle down
        ...
        if(controlTick%10==0){
            ...
            loco_plan->mpcdataLog(q0, opt_HLMPC_state.block(16,0,12,1), foot_position, controlMPC);

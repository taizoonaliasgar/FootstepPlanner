...
void SRBNMPC::generator(){
    ...
    // file name
    std::string file_name = "Go2_w0p2_ro_0p05_27b";//"take2_1";
    // code predix
...
casadi::SX SRBNMPC::UpdateCostN(casadi::SX x, casadi::SX x_des){
    ...
    Q.block(3,3,3,3).diagonal() <<  5e2,1e4,1e3;//4e5//5e4//mpc_params.qvx, mpc_params.qvy, mpc_params.qvz;
    ...
    Q.block(12,12,4,4).diagonal() <<  1e4,1e4,1e4,1e4;//1e-2//1e3//1e5,1e5,1e5,1e5;

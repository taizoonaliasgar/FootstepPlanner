...
void SRBNMPC::generator(){
    ...
    // file name
    std::string file_name = "Go2_w0p2_ro_0p05_5";//"take2_1";
    // code predix
...
casadi::SX SRBNMPC::UpdateCostN(casadi::SX x, casadi::SX x_des){
    ...
    Q.setZero();
    Q.block(0,0,3,3).diagonal() <<  1e5,1e5,8e5;//5e4//1e4//mpc_params.qpx, mpc_params.qpy, mpc_params.qpz;
...
void SRBNMPC::planner_MT(size_t controlTick, double q[18], double dq[18], Eigen::Matrix<double, 3, 4> foot_position, Eigen::Matrix<double, 12, 1> lastQPforce){
   ...
   // auto end02 = std::chrono::high_resolution_clock::now();
    ...
    p_MT = motionPlannerN_MT30(q0_MT,controlMPC_MT);

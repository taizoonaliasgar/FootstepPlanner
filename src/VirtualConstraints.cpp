        ...
        for(size_t i=0; i<4; i++){
            if(con->ind[i]==0){
                ...
                if(i>1){
                    ...
                    double az[8]= {traj->toeInit(2,i), traj->toeInit(2,i), 0.5*params->swingHeight, 1*params->swingHeight, 
                                1*params->swingHeight, 0.5*params->swingHeight, 0.019,0.019};//traj->toeInit(2,i),traj->toeInit(2,i)};//0.02, 0.02};//to+0.01, to};
                    calcBezierAll(n, az, phase, tz);

...
void setupCallback() {
    ...
    */
    ...
    vis->addResourceDirectory("/home/taizoon/raisimEnv/raisimWorkspace/flying_trot/material_collection");
...
void planner(std::vector<raisim::ArticulatedSystem*> srbx2, 
                ...
                SRBNMPC* mpc_obj, casadi::Function solver, casadi::DM contact_sequence){
